...
// This form is used for creating a new invoice, so it doesn't receive an invoice prop like the edit form does.
//  Instead, it only receives the list of customers to populate the dropdown.
