...
// This form is used for editing an existing invoice, so it receives both the invoice data and the list of customers.
// The invoice data is used to pre-populate the form fields, while the customers list is used to populate the dropdown.
export default function EditInvoiceForm({
  ...
  // We need to bind the invoice ID to the updateInvoice action since the form doesn't include the ID field.
